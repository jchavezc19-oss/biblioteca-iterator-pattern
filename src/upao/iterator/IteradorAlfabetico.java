...
public class IteradorAlfabetico implements IteradorInterface {
    ...
    public IteradorAlfabetico(List<RecursoBibliografico> recursosOriginales) {
        // Clonación defensiva para aislar los datos internos y no alterar la base de datos original
    ...
    public boolean hasNext() {
        // Retorna verdadero si el puntero no ha superado el tamaño máximo de la lista ordenada
    ...
    public RecursoBibliografico next() {
        ...
        // Extrae el recurso en la posición del puntero y lo incrementa de inmediato (++ en postfijo)
